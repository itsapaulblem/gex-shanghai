...
function LandingScreen() {
  return (
    <div className="min-h-full bg-[#F7F4EF] flex flex-col">
      {/* Nav */}
      <div className="border-b border-[#D8D0C4] bg-white px-8 py-4 flex items-center justify-between">
      ...
      <div className="relative overflow-hidden border-b border-[#D8D0C4]">
        <div className="grid grid-cols-2 min-h-[340px]">
          <div className="bg-[#F7F4EF] px-12 py-12 flex flex-col justify-center">
          ...
          {/* Hero visual */}
          <div className="bg-[#EEE9E0] relative flex items-end">
            <div className="absolute inset-4 border border-dashed border-[#C8C0B0] rounded flex flex-col items-center justify-center gap-3">
              <WireBox className="w-40 h-28 rounded" label="<photo to be added>" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-12 py-10">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            ...
            <div key={item.step} className="bg-white border border-[#D8D0C4] rounded p-5">
      ...
      {/* Footer */}
      <div className="mt-auto border-t border-[#D8D0C4] px-12 py-4 flex justify-between items-center">
...
function ChatScreen() {
  ...
  return (
    <div className="min-h-full bg-[#F7F4EF] flex flex-col">
      {/* Header */}
      <div className="border-b border-[#D8D0C4] bg-white px-8 py-4 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-[#B5272A] rounded-sm flex items-center justify-center">
            <span className="text-white font-serif text-sm font-bold">缘</span>
          </div>
...
export default function App() {
  ...
  return (
    <div className="size-full flex bg-[#2A2218] overflow-hidden" style={{ fontFamily: "'Noto Sans SC', sans-serif" }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Screen content */}
        <div className="flex-1 overflow-auto bg-[#F7F4EF]">{renderScreen()}</div>
      </div>
    </div>
  );
}
